...
Examples
--------
	python scripts/local/calc_datas.py --sim_type 1d
	python scripts/local/calc_datas.py --sim_type 2d
"""
...
def main() -> None:
	...
	if saved_paths:
		...
		print(
			f"     python \"{process_script}\" --abs_path '{saved_paths[-1]}' --skip_if_exists"
		)
